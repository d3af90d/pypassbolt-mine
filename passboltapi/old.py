...
class APIClientOld:
    ...
    def list_users(
        ...
        users = tuple_constructor(
            PassboltUserTuple,
            subconstructors={"gpgkey": tuple_constructor(PassboltOpenPgpKeyTuple)},
        )(r.json()['body'])
...
class PassboltAPIOld(APIClientOld):
    ...
    def list_resources(self, folder_id: Optional[PassboltFolderIdType] = None):
        ...
        return tuple_constructor(PassboltResourceTuple)(response["children_resources"])
    ...
    def list_users_old(
        self, resource_or_folder_id: None|PassboltResourceIdType|PassboltFolderIdType = None,
        force_list=True
    ) -> List[PassboltUserTuple]:
        if resource_or_folder_id is None:
            params = {}
    ...
    def read_resource(self, resource_id: PassboltResourceIdType) -> PassboltResourceTuple:
        ...
        return tuple_constructor(PassboltResourceTuple)(response)
    ...
    def read_resource_type(self, resource_type_id: PassboltResourceTypeIdType) -> PassboltResourceTypeTuple:
        ...
        response = response.json()["body"]
        return tuple_constructor(PassboltResourceTypeTuple)(response)
    ...
    def read_folder(self, folder_id: PassboltFolderIdType) -> PassboltFolderTuple:
        ...
        return tuple_constructor(PassboltFolderTuple, subconstructors={"permissions": tuple_constructor(PassboltPermissionTuple)})(
            response["body"]
        )
    ...
    def describe_folder(self, folder_id: PassboltFolderIdType):
        ...
        return tuple_constructor(
            PassboltFolderTuple,
            subconstructors={
                "permissions": tuple_constructor(PassboltPermissionTuple),
            }
        )(response["body"])
    ...
    def create_resource(
        ...
        resource = tuple_constructor(PassboltResourceTuple)(r_create.json()["body"])
        if folder_id:
    ...
    def describe_group(self, group_id: PassboltGroupIdType):
        ...
        return tuple_constructor(PassboltGroupTuple)(response["body"])
